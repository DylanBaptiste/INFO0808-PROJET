...
```{r, warning=FALSE}
plot_ly(d1, x=~day(Date)) %>% add_boxplot(y=~Count) %>% layout(title = "Nombre d'accident en fonction du jour du mois de l'annee de 2005 à 2019",xaxis=list(title="Jours du mois", yaxis=list(title="Nombre d'accidents")))
